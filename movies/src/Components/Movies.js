...

            {
                movies.length == 0 ?
                    ...
                    <div className='font-bold text-2xl flex justify-center mb-4 flex-wrap '>
                        {
                            movies.map((movie) => (
                                <div className={`border-gray-900 border-2 rounded-xl m-4 bg-[url(https://image.tmdb.org/t/p/original/${movie.backdrop_path})] h-[60vh] w-[20vw] bg-center bg-cover flex items-end hover:scale-110 transition delay-10 duration-500 ease-in-out scroll-smooth`}>
